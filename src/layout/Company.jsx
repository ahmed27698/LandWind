...
const Company = () => {
    return (
        <section className='flex justify-between lg:px-[80px] md:px-[30px] px-[10px]' id='company'>
            <div className='lg:w-6/12 grid pt-10 gap-2'>
                <div className='grid gap-5'>
                    <p className='text-6xl font-black'>Building digital products & brands.</p>
                ...
                <div className='flex gap-5 h-12'>
                    <button className='bg-purple-600 text-white p-2 rounded-xl'>Start 30 Day Free Trial</button>
                    <button className='bg-gray-50 text-gray-800 border-1 border-gray-200 p-2 rounded-xl'>Pricing & FAQ</button>
                </div>
            </div>
            <img className='lg:w-4/12' src="../../public/marketing-strategy 1.png" alt="marketing strategy image" />
        </section>
    )
}
